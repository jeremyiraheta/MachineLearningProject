    ...
    <div style="padding: 55px 25% 37px">
        ...
        <table style="border: solid 2px;">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtBirth" runat="server" Width="90%" TextMode="Date"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidato7" runat="server" ControlToValidate="txtBirth" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
                <td style="padding: 10px 20px 0px 20px">
