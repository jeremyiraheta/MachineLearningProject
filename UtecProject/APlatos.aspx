<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="APlatos.aspx.cs" Inherits="PRProject.APlatos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="c1" runat="server">
    <div style="padding: 55px 25% 37px">
        ...
        <td><asp:TextBox ID="txtDname" runat="server" Width="90%"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtDname" ForeColor="Red"></asp:RequiredFieldValidator>
            </td></tr>        
        <tr><td style="padding:10px 20px 0px 20px"><asp:Label ID="Label5" runat="server" Text="Restaurante:"></asp:Label></td>
        <td>
            <asp:DropDownList ID="ddRestaurantes" Width="90%" runat="server">
            </asp:DropDownList>
            </td></tr>        
        ...
        <td>
            ...
            <asp:TextBox ID="txtDescripcion" runat="server" Width="90%" TextMode="MultiLine" Height="59px"></asp:TextBox>
            
            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*" ForeColor="Red" ControlToValidate="txtDescripcion"></asp:RequiredFieldValidator>
